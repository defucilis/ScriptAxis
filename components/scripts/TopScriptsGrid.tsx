...
import style from "./TopScriptsGrid.module.scss";
...
const TopScriptsGrid = ({ initialScripts }: { initialScripts?: Script[] }): JSX.Element => {
    ...
    useEffect(() => {
        ...
        fetchScripts();
    }, [orderBy, timePeriod, usingInitialScripts]);

    return (
        <div className={style.topScriptsGrid}>
